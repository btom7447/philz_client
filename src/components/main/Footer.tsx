...
export default function Footer() {
  ...
  return (
    <section className="border-t border-gray-200 bg-purple-50 pt-5 ">
      <NewsletterSection />
      <footer className="pb-5 relative">
        <div className="max-w-7xl mx-auto px-5 xl:px-0 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-[320px_320px_1fr_1fr] gap-10">
          ...
          <div className="flex flex-col gap-5">
            ...
            <p className="text-gray-700 text-lg leading-relaxed">
              ...
              service and expert guidance to help you find your dream property.
            </p>
            <div className="mt-10">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col items-start gap-2">
              ...
              <div className="flex items-center gap-5">
                <Mail
                  className="w-10 h-10 mt-1 text-purple-700"
                  strokeWidth={1}
                />
